...
- **run 11**: k!·m − 1 prime for k = 1..11; the 11th value is
  3,328,981,507,539,071,999. **stopper** 12!·m − 1 =
  39,947,778,090,468,863,999 = 73 × 547,229,836,855,737,863.
- 11 `deterministic-mr` certificates (m under the crossing 8.3e16).
- **model**: from a(10), median 3.37e10; m / median = 2.47, E = 1.39.
- m = 2² · 3³ · 5 · 3259 · 47389.
...
- **run 12**: the 12th value is 3,707,797,456,515,043,583,999. **stopper**
  13!·m − 1 = 48,201,366,934,695,566,591,999 = 67 ×
  719,423,387,085,008,456,597.
- 12 `deterministic-mr` certificates.
- **model**: from a(11), median 1.59e12; m / median = 4.86, E = 2.18.
- m = 2 · 3² · 5 · 29 · 151 · 4001 · 4909.
...
- **run 13**: the 13th value is 2,966,444,017,039,342,135,295,999, the
  ...
  14!·m − 1 = 41,530,216,238,550,789,894,143,999 = 6,029 ×
  6,888,408,730,892,484,639,931.
- 13 `deterministic-mr` certificates (m just under the crossing 5.3e14).
- **model**: from a(12), median 7.30e13; m / median = 6.52, E = 2.97 — the
  latest of the sixteen against its model.
- m = 2⁴ · 3 · 5 · 5779 · 343472447.
...
- **run 14**: the 14th value is 85,885,734,305,147,893,788,671,999.
  **stopper** 15!·m − 1 = 1,288,286,014,577,218,406,830,079,999 = 67 ×
  19,228,149,471,301,767,266,120,597.
- **certificates**: m is past the proof crossing (3.8e13 at n = 14), so
  this is the project's first find proved by certificate: 12
  `deterministic-mr`, 2 **BLS75 Theorem 15**.
- **model**: from a(13), median 3.14e15; m / median = 0.31, E = 0.17 —
  only 2.07 × a(13).
- m = 2⁴ · 3 · 5 · 7 · 13 · 17 · 19 · 23 · 6071971.
...
- **run 15**: the 15th value is 140,701,616,528,570,312,179,700,735,999.
  **stopper** 16!·m − 1 = 2,251,225,864,457,124,994,875,211,775,999 =
  54,437 × 41,354,701,112,425,831,601,212,627.
- 10 `deterministic-mr`, 5 BLS75 Theorem 15.
- **model**: from a(14), median 6.74e16; m / median = 1.60, E = 0.97.
- m = 2² · 3 · 13 · 31 · 2889781 · 7699247 — no 5, no 7, no 11: nothing
...
- **run 16**: the 16th value is
  15,584,508,752,384,283,395,431,587,839,999. **stopper** 17!·m − 1 =
...
- **model**: from a(16), median 1.48e20; m / median = 1.07, E = 0.73.
...
- **run 18**: the 18th value is
  10,494,795,883,259,311,979,025,056,275,169,279,999. **stopper** 19!·m − 1
  = 199,401,121,781,926,927,601,476,069,228,216,319,999 = 67 ×
  2,976,136,145,998,909,367,186,209,988,480,840,597.
- 6 `deterministic-mr`, 12 BLS75 Theorem 15; every prime factor of m under
  the deterministic bound, so no subproof.
- **model**: from a(17), median 6.70e21; m / median = 0.24, E = 0.22 —
  early in m, and still 5.75 hours in: the n = 18 segment is 160 periods of
  the wheel to 53, 5.2e21 wide, and the find was narrated at its close.
- m = 2³ · 3³ · 5 · 127 · 3359 · 26953 · 132004393.
- evidence: `evidence/A177013_a18_1639203889936938872760.json`

`E` averages **1.10** over the eight; m / median runs 2.47, 4.86, 6.52, 0.31,
1.60, 0.21, 1.07, 0.24.
...
the wheel to 53, m = 5,409,800,307,213,547,425,180, the close of the n = 18
segment that held a(18) — every survivor in it run on to n + 8 and none
reaching 19. So **no m < 5.4098e21 has k!·m − 1 prime for all k = 1..19**,
...
- **run 11**: k!·m + 1 prime for k = 1..11; the 11th value is
  5,328,621,709,762,982,401. **stopper** 12!·m + 1 =
...
- **model**: from a(10), median 2.40e10; m / median = 5.57, E = 2.13.
- m = 2 · 3 · 7 · 11² · 26267849.
...
- **run 12**: the 12th value is 453,405,774,091,286,016,001. **stopper**
  13!·m + 1 = 5,894,275,063,186,718,208,001 = 173 ×
  34,070,954,122,466,579,237.
- 12 `deterministic-mr` certificates.
- **also settles**: A226935(12) = 946,564,216,261.
- **model**: from a(11), median 1.73e12; m / median = 0.55, E = 0.42.
- m = 2² · 3 · 5 · 13 · 421 · 2882527.
- evidence: `evidence/A177014_a12_946564216260.json`

#### a(13) = a(14) = a(15) = 63,877,984,659,108 — 20:27:36

- **run 15, found while a(13) was open**: k!·m + 1 is prime for every
  k = 1..15, so this one m settles three terms at once — a **rider**, as the
  published a(9) = a(10) is. The 15th value is
  83,531,603,218,212,749,343,744,001. **stopper** 16!·m + 1 =
...
- **also settles**: A226935(13) = A226935(14) = A226935(15) =
  63,877,984,659,109.
- **model**: from a(12), a(13)'s median 5.51e13; m / median = 1.16,
...
- **model**: from a(15), median 3.11e18; m / median = 0.76, E = 0.57.
- m = 2² · 3² · 5 · 17 · 47 · 16386773515817.
- evidence: `evidence/A177014_a16_2356745767044800940.json`

#### a(17) = 118,296,999,554,873,123,520 — 20:50:03

- **run 17**: the 17th value is
  42,076,755,523,146,478,128,422,926,417,920,001. **stopper** 18!·m + 1 =
...
- **model**: from a(16), median 1.55e20; m / median = 0.77, E = 0.57.
  23 minutes in, at the close of the first n = 17 segment.
- m = 2⁶ · 3³ · 5 · 83 · 164961233203471.
...
- **run 18**: the 18th value is
  ...
  this project has certified. **stopper** 19!·m + 1 =
  3,760,255,644,382,072,765,602,767,831,755,898,880,001 = 853,091 ×
  4,407,801,329,966,056,101,403,915,680,456,011.
- 4 `deterministic-mr`, 14 BLS75 Theorem 1; the largest prime factor of m,
...
filter has moved to n = 19 and both cursors stand at period 966, m =
31,481,127,088,965,583,209,180, with nothing pending. Every survivor below
it was run on to n + 8 and none reached 19, so **no m < 3.1481e22 has
k!·m + 1 prime for all k = 1..19** — and therefore A226935(19) >
31,481,127,088,965,583,209,181.

### The least-claim basis, and why the bounds hold above the crossing

Each find is a **first occurrence**: every m from the published frontier to
the find swept at unit 6 and every survivor classified in m order, with
monotonicity (a(n) ≥ a(n − 1)) the floor below. The basis is written into
every evidence file — `swept_from_m`, `covered_by_previous_filter_to` (a
promotion carries the classified line, README.md "One line"), `swept_to_m`,
...
The proof crossing is very low here (m = 5.2e8 at n = 18), so almost all of
...
| m / median, range | 0.21–6.52 | 0.55–5.57 | geometric mean **1.24** |
...
| A177013 n = 17 | 2.20e20 | 22.6 min | 1.62e17 m/s | 1.6e17 (`SCORE`) |
...
1/log(k!·m) does. The short lengths are counts of *sieve survivors*, not
densities: a filter-n sieve removes an m with a short run whenever one of
...
| entry | frontier (all this project's) | open next | searched empty below | resumes at | median from the bound | at ~3.8e17 m/s |
|---|---|---|---|---|---|---|
