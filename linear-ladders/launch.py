...
PERIOD of this engine's wheel.  Five campaigns have run (2026-09-03,
...
Those checkpoints sit at their ceilings, so a resume of any of them stops
at once; `--fresh` would re-sweep the whole line.
