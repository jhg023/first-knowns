...
its 17-minute campaign the same evening, and A125839's `a(16)` to
`a(18)`, from its 15-minute one, with a ledger per family.
...
their certificates are the seven-base test. Every file was re-verified
