...
`a(18)` was open, `settles = [18, 19]`), from its 37-minute one, and
A164326's `a(15)` and `a(16)` from its 14-minute one, with a ledger per
family.
...
and the other three the deterministic test. A125838, A125839 and A164326
