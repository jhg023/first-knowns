...
| [square-ladders](square-ladders/) | [A089761](https://oeis.org/A089761): the least k such that k·i²+1 is prime for every i = 1..n — a Dickson ladder whose rungs are the squares | **PAUSED — open to others** — no results yet: engine, 24-gate battery and validated odds model are green at **SCORE 207,468,780**, and no production sweep has been run. The frontier is the stalest in this repo: a(11) (Donovan Johnson, 2008) is the last term anyone searched for, and a(12)–a(15) are the *same integer* riding on it — a(16) is open because of one composite, 861066640·16²+1 = 47·149·31476947. Alekseyev's a(16) > 1.4×10¹³ is the only work since. At 2.07×10¹⁴ k/s the model's a(16) median is **10 seconds** and the engine's whole enforced range is 12 hours — one overnight run |
