...
| [shift-ladders](shift-ladders/) | [A130003](https://oeis.org/A130003) and [A110096](https://oeis.org/A110096): the least m such that m + b^k is prime for every k = 1..n, at b = 4 and b = 2 — shift ladders, whose killed set is a geometric orbit rather than a quadratic one | **ACTIVE — engine green, no sweep run yet** — the five-file skeleton is complete and its full battery is green, but no production sweep has been run and there are no results to report. Next open: a(19) of A130003, whose frontier has stood since 2007, and a(17) of A110096. |
