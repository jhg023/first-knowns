...
| [lcm-ladders](lcm-ladders/) | [A078502](https://oeis.org/A078502) and [A074200](https://oeis.org/A074200) (with [A093554](https://oeis.org/A093554) and [A093553](https://oeis.org/A093553) riding on them): the least N such that (N ± k)/k is prime for every k = 1..n — lcm ladders, whose multipliers are lcm(1..n)/k, so the small primes are nearly blind where every other ladder here has them maximal | **ACTIVE** — no terms found yet; the engine, the 44-gate battery and the campaign are built and green 2026-09-06, and tuned over seven measured rounds to 1.4-1.75x of the engine it started from. Ready to start at a(15) of both families, the first advance on either since 2003 and 2004, with a(15), a(16) and a(17) about two hours of device between them. |
