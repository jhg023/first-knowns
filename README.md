...
| [dickson-ladders](dickson-ladders/) | [A247965](https://oeis.org/A247965): the least k such that m·k²+1 is prime for every m = 1..n — a Dickson ladder whose n = 1 case is Landau's k²+1 problem | **ACTIVE** — engine built, gated and benchmarked; no production leg started yet. The frontier is where Hiroaki Yamanouchi left it in October 2014: a(9) = 3,332,396,388,090, with a(10) > 1.54665×10¹³ and no upper bound published at any open term. Model medians: a(10) 1.68×10¹⁵ (~4 min at the measured rate), a(11) 7.18×10¹⁶, a(12) 1.83×10¹⁹ |
