...
| [dickson-ladders](dickson-ladders/) | [A247965](https://oeis.org/A247965): the least k such that m·k²+1 is prime for every m = 1..n — a Dickson ladder whose n = 1 case is Landau's k²+1 problem | **ACTIVE** — a(10) = 9,328,409,578,841,430, a(11) = 433,871,469,806,557,860 and a(12) = 55,119,263,286,518,170,740 found & verified 2026-08-18 (the first advance since 2014), each with a primality certificate for all of its values and re-verified from its evidence before publication. Prior frontier: Hiroaki Yamanouchi's a(9) = 3,332,396,388,090, Oct 2014. The campaign is running on **a(13)**, past the model's P90 at k = 1.10×10²², after a 27.9× campaign re-configuration (2026-08-18, which found a(12) 9 min 45 s in) and a further **2.39×** from the v4 fold (2026-08-19, first sieve prime folded into candidate generation) — **2.3×10¹⁷ k/s**, with the reach extended 17× to k = 2.04×10²⁴ so that **a(14)** sits inside the same sweep at 98.8% model odds. All three finds landed late — model quantiles 0.915, 0.923 and 0.787, pooled optimism 2.2× with an interval that still contains 1 |
