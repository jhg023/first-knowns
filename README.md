...
| [shift-ladders](shift-ladders/) | [A130003](https://oeis.org/A130003) and [A110096](https://oeis.org/A110096): the least m such that m + b^k is prime for every k = 1..n, at b = 4 and b = 2 — shift ladders, whose killed set is a geometric orbit rather than a quadratic one | **ACTIVE** — five terms found & verified 2026-08-23/27: a(19) and a(20) of A130003, the first advance there since 2007, and a(17), a(18), a(19) of A110096. Hunting A130003 a(21) now from m = 8.95×10¹⁸ at 8.20×10¹⁴ m/s, 5.8× the first campaign; A110096 is empty below 5.64×10²³ and its a(20) is only 13% likely to sit under the engine's proof ceiling. |
