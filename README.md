...
| [prime-power-sums](prime-power-sums/) | [A125827](https://oeis.org/A125827) and six sibling families: the k that divide the sum of the m-th powers of the first k primes — one sweep of the prime line feeding seven open sequences at once (fourteen with their prime-reported partners) | **ACTIVE** — no results yet, but **the campaign is startable**: four independent implementations, the odds model (observed/predicted 1.07, 95% [0.83, 1.31] over 74 published terms) and the full battery are green at **SCORE 58,754** (v1: 95, same fingerprint), and the v2 engine measures **3.3×10¹⁰ p/s at campaign height** against v1's 3.3×10⁷ there — the nearest target goes from 8.7 years to about eleven days, and new ground on five of the seven families begins after six. Frontiers are Paul W. Dyson's and Bruce Garner's, held on CPUs and moved as recently as Jan 2025; their own bounds show the opening — k = 6.5×10¹⁵ at m = 1, where the running sum fits in 128 bits, against 5×10¹⁴ at m ≥ 8, where it does not |
